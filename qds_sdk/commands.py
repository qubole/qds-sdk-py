    ...
    def get_results(self, fp=sys.stdout, inline=True, delim=None, fetch=True):
        ...
        if r.get('inline'):
            ...
            if fetch:
                ...
                boto_conn = boto.connect_s3(aws_access_key_id=storage_credentials.storage_config.get('access_key'),
                                            aws_secret_access_key=storage_credentials.storage_config.get('secret_key'),
                                            security_token = storage_credentials.storage_config.get('session_token'))
