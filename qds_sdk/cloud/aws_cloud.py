...
class AwsCloud(Cloud):
    ...
    def set_composition_arguments(self, comp_group):
        ...
        comp_group.add_argument("--master-timeout-for-request",
                                dest="master_timeout_for_request",
                                type=int,
                                default=1,
                                help="timeout for a master spot instance request, unit: minutes")
        comp_group.add_argument("--master-spot-fallback",
        ...
        comp_group.add_argument("--min-spot-block-percentage",
        ...
        comp_group.add_argument("--min-spot-block-duration",
                                dest="min_spot_block_duration",
                                type=int,
                                default=120,
                                help="spot block duration unit: minutes")
        comp_group.add_argument("--min-maximum-bid-price-percentage",
                                ...
                                help="maximum value to bid for min spot instances" +
                                     " expressed as a percentage of the base" +
                                     " price for the master instance types")
        comp_group.add_argument("--min-timeout-for-request",
        ...
        comp_group.add_argument("--min-spot-fallback",
                                ...
                                help="whether to fallback to on-demand instances for min nodes" +
                                     " if spot instances aren't available")
        comp_group.add_argument("--min-spot-allocation-strategy",
        ...
        comp_group.add_argument("--autoscaling-spot-block-percentage",
        ...
        comp_group.add_argument("--autoscaling-spot-block-duration",
                                dest="autoscaling_spot_block_duration",
                                type=int,
                                default=120,
                                help="spot block duration unit:  minutes")
        comp_group.add_argument("--autoscaling-spot-block-fallback",
        ...
        comp_group.add_argument("--autoscaling-maximum-bid-price-percentage",
