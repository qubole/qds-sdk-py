...
class TestRoleCheck(QdsCliTestCase):
    ...
    def test_view(self):
        ...
        Connection._api_call.assert_has_calls(
            call("GET", "roles/123", params=None))
    ...
    def test_update_policy(self):
        ...
        Connection._api_call = Mock(return_value={'roles': []})
        qds.main()
        Connection._api_call.assert_has_calls(call("PUT", "roles/123", {
    ...
    def test_duplicate_with_name(self):
        ...
        qds.main()
        Connection._api_call.assert_has_calls(
            call("POST", "roles/123/duplicate", {'name': 'duplicate'}))
    ...
    def test_assign_role(self):
        ...
        qds.main()
        Connection._api_call.assert_has_calls(
            call("PUT", "groups/456/roles/123/assign", None))
    ...
    def test_unassign_role(self):
        ...
        qds.main()
        Connection._api_call.assert_has_calls(
            call("PUT", "groups/456/roles/123/unassign", None))
    ...
    def test_list_groups(self):
        ...
        qds.main()
        Connection._api_call.assert_has_calls(
            call("GET", "roles/123/groups", params=None))
